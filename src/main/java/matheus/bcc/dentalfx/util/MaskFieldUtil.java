...
public abstract class MaskFieldUtil {
    ...
    public static void serialTextField(final TextField textField) {
        ...
        textField.lengthProperty().addListener((ObservableValue<? extends Number> observable, Number oldValue, Number newValue) -> {
            if (newValue.intValue() < 24) {
                ...
                Platform.runLater(() -> textField.setText(finalValue.toUpperCase()));
    ...
    public static void dateField(final TextField textField) {
        ...
        textField.lengthProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue.intValue() < 11) {
                ...
                String finalValue = value;
                Platform.runLater(() -> textField.setText(finalValue));
    ...
    public static void foneField(TextField textField) {
        ...
        textField.lengthProperty().addListener((observableValue, number, number2) -> {
                    try {
                        String value = formatarFone(textField.getText());
    ...
    public static <T> void foneField(TableColumn<T, String> col) {
        col.setCellFactory(column -> new TableCell<>() {
            @Override
            protected void updateItem(String fone, boolean empty) {
                super.updateItem(fone, empty);
                setText(formatarFone(fone));
            }
        });
    }
    ...
    private static String formatarFone(String fone) {
        if (fone != null) {
            ...
            if (tam > 10) {
                ...
                fone = fone.replaceFirst("(\\d{5})(\\d)", "$1-$2");
            }
            return fone;
        }
        return "";
